                              ...
                              children: [
                                Container(
                                  ...
                                  child: Visibility(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final listLocsFavs = _model.favjsonObjct
                                            .map((e) => e)
                                            .toList();
                                                                  ...
                                                                  await showDialog(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        ...
                                                                        content:
                                                                            Text((_model.apiResulth6xCopy?.bodyText ??
                                                                                '')),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Visibility(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final listLocs = _model.jsonObjct
                                              .map((e) => e)
                                              .toList();
                                          return ListView.builder(
                                            padding: EdgeInsets.zero,
                                                                  ...
                                                                  if ((_model
                                                                    ...
                                                                    if ((_model
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        _model
                                                                            .jsonObjct = getJsonField(
                                                                          (_model.apiResult3dpd?.jsonBody ??
                                                                              ''),
                                                                          r'''$.data''',
                                                                          true,
                                                                        )!
